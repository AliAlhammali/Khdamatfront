...
export default {
  ...
  async mounted() {
    await this.getBranchesClient(this.params);
  },
  computed: {
    ...mapState(useBranchesClientStore, ["records", "uiFlags"]),
    headers() {
      return [
        {
          title: "#",
  ...
  methods: {
    ...mapActions(useBranchesClientStore, [
      "getBranchesClient",
      "deleteBranchesClient",
    ]),
    ...
    async deleteRecord(item) {
      ...
      if (result.isConfirmed) {
        await this.deleteBranchesClient(item.id);
      }
    },
    ...
    async search(text) {
      ...
      await this.getBranchesClient(key);
    },
  },
};
</script>
